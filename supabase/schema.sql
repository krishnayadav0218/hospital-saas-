...
create policy "read patient documents" on storage.objects
  for select using (bucket_id = 'patient-documents' and public.category_read_ok('patients'));
...
create policy "upload patient documents" on storage.objects
  for insert with check (bucket_id = 'patient-documents' and public.category_write_ok('patients'));
