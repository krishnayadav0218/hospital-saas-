...
-- Bootstrap: automatically create a profile row whenever someone signs
-- up. The very first person to ever sign up becomes admin; everyone
-- after that starts as 'pending' until an existing admin assigns them
-- a role from the app's Users page.
